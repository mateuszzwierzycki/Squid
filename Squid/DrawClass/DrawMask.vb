...
Public Class DrawMask
    ...
    Friend Property Rectangle As Rectangle3d
        Get
            Return rect
        End Get
    ...
    Friend Property Interpolation As Integer
        Get
            Return inter
        End Get
    ...
    Public Function Duplicate() As DrawMask
        Dim n As New DrawMask(bmp.Clone, rect, inter)
        Return n
    End Function
