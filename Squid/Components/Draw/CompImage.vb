...
Public Class CompImage
    ...
    Sub New()
        MyBase.New("Image", "Image", "Draw an image", "Squid", "Instructions")
    End Sub

    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return New Guid("{536490C5-2F09-4695-9919-15BD2983B4FF}")
        End Get
    End Property

    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return My.Resources.drawimage
        End Get
    End Property

    Protected Overrides Sub RegisterInputParams(pManager As Grasshopper.Kernel.GH_Component.GH_InputParamManager)
        pManager.AddParameter(New ParamSquidBitmap)
        pManager.AddRectangleParameter("Bounds", "R", "Image bounds", GH_ParamAccess.item, New Rectangle3d(Plane.WorldXY, 100, 100))
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        DA.SetData(0, New InstrImage(New DrawImage(sqb.Image, rect, inter)))
